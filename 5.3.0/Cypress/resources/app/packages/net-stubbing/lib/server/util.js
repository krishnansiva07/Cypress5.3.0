...
var xhrs_1 = require("../../../server/lib/controllers/xhrs");
...
function setBodyFromFixture(getFixtureFn, staticResponse) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, getFixtureFn(fixture.filePath, { encoding: fixture.encoding })];
                case 1:
                    data = _a.sent();
                    headers = staticResponse.headers;
                    if (!headers || !caseInsensitiveGet(headers, 'content-type')) {
                        lodash_1.default.set(staticResponse, 'headers.content-type', xhrs_1.parseContentType(data));
                    }
...
exports.setBodyFromFixture = setBodyFromFixture;
/**
