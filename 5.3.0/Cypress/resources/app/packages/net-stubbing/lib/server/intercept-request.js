...
function _doesRouteMatch(routeMatcher, req) {
    ...
    stringMatcherFields.forEach(function (field) {
        ...
        match = match && minimatch_1.default(value, matcher, { matchBase: true });
    });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, util_1.setBodyFromFixture(backendRequest.route.getFixture, frame.staticResponse)];
                case 1:
                    _a.sent();
